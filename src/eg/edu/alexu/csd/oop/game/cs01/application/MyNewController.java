...
public class MyNewController implements Initializable{
    ...
    void leaderBoardAct(MouseEvent event) {
    	try {
    		...
    		Parent root = FXMLLoader.load(getClass().getResource("/eg/edu/alexu/csd/oop/game/cs01/application/LeaderboardTable.fxml"));
    ...
    public void loadGameAct(MouseEvent event) {
    	try {
    		Stage primaryStage = new Stage();
    		Parent root = FXMLLoader.load(getClass().getResource("/eg/edu/alexu/csd/oop/game/cs01/application/LoadGame.fxml"));
			StackPane pane = new StackPane();
			pane.getChildren().add(root);
			Scene scene = new Scene(pane);
			primaryStage.setScene(scene);
    ...
    void newGameAct(MouseEvent event) {
    	try {
    		Stage primaryStage = new Stage();
    		Parent root = FXMLLoader.load(getClass().getResource("/eg/edu/alexu/csd/oop/game/cs01/application/NewGame.fxml"));
			StackPane pane = new StackPane();
